              ...
              <div className="space-y-4">
                {coreValues.map((value, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="p-4 rounded-2xl bg-slate-50 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800/80 flex gap-4 hover:border-lime-500/40 dark:hover:border-lime-400/40 hover:shadow-md transition-all duration-300"
                    >
                      <div className="p-2.5 rounded-xl bg-lime-100 dark:bg-lime-950/30 text-lime-700 dark:text-lime-400 h-10 w-10 flex items-center justify-center flex-shrink-0">
                        <Icon size={20} />
                      </div>
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold flex items-center gap-2">
                <GraduationCap size={24} className="text-lime-600 dark:text-lime-450" />
                Education
              </h3>
              <div className="space-y-6 relative border-l-2 border-slate-200 dark:border-zinc-800 pl-6 ml-3">
                {education.map((edu, idx) => (
                  <div key={idx} className="relative space-y-1">
                    {/* Timeline Node dot */}
                    <div className="absolute -left-[31px] top-1.5 w-3 h-3 rounded-full bg-lime-600 dark:bg-lime-450 border border-white dark:border-bg-dark" />
                    <span className="text-xs font-bold text-lime-650 dark:text-lime-450 uppercase tracking-wider">
                      {edu.year}
                    </span>
                    ...
                    <p className="text-xs text-slate-505 dark:text-slate-400 leading-relaxed pt-1">
                      {edu.details}
                    </p>
                  </div>
                ))}
            ...
            {/* Quote block */}
            <div className="p-6 rounded-2xl bg-slate-100/60 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800/80 shadow-sm relative overflow-hidden flex flex-col justify-center hover:border-lime-500/25 transition-colors duration-300">
              <span className="text-5xl text-lime-600/10 dark:text-lime-400/15 font-serif leading-none h-4">“</span>
